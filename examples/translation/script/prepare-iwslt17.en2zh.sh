...
# manually download corresponding datasets from https://wit3.fbk.eu/archive/2017-01-trnted//texts/en/zh/en-zh.tgz
# ,https://wit3.fbk.eu/archive/2017-01-ted-test//texts/zh/en/zh-en.tgz, and
# https://wit3.fbk.eu/archive/2017-01-ted-test//texts/en/zh/en-zh.tgz.
# Put the extracted files under $orig folder
...
for l in $src $tgt; do
    cat $tmp/train.tags.$lang.tok.$l > $tmp/train.tags.$lang.$l
done
