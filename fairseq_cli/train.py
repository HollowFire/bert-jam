...
def main(args, init_distributed=False):
    ...
    if not args.finetune_bert and not args.adjust_layer_weights:
        for param in model.bert_encoder.parameters():
            param.requires_grad = False
        for name, param in model.encoder.layers.named_parameters():
            if 'glu' in name:
                param.requires_grad = False
        for name, param in model.decoder.layers.named_parameters():
            if 'glu' in name:
                param.requires_grad = False
    elif not args.finetune_bert and args.adjust_layer_weights:
        for param in model.bert_encoder.parameters():
            param.requires_grad = False
    elif args.finetune_bert and not args.adjust_layer_weights:
